package ru.mirea.pavlov.securesharedpreferences;
...
import ru.mirea.pavlov.securesharedpreferences.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            secureSharedPreferences.edit().putString("POET", "Иван Алексеевич Бунин").apply();
