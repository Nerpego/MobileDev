package ru.mirea.pavlov.thread;
...
import ru.mirea.pavlov.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: БСБО-03-20, НОМЕР ПО СПИСКУ: 20, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Твое имя");
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { new Thread(new Runnable() {
                public void run() {
                    ...
                    Log.d("ThreadProject", String.format("Запущен поток № %d студентом группы № %s номер по списку № %s ", numberThread, "БСБО-03-20","20"));
